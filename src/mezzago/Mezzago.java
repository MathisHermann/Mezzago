...
import mezzago.appClasses.Mezzago_Controller;
import mezzago.appClasses.Mezzago_Model;
import mezzago.appClasses.Mezzago_View;
import mezzago.splashScreen.Splash_Controller;
import mezzago.splashScreen.Splash_Model;
import mezzago.splashScreen.Splash_View;
 ...
 */
public class Mezzago extends Application {
    private static Mezzago mainProgram; // singleton
    private Splash_View splashView;
    private Mezzago_View view;
    ...
    public void startApp() {
        ...
        Mezzago_Model model = new Mezzago_Model();
        view = new Mezzago_View(appStage, model);
        new Mezzago_Controller(model, view);
    ...
    protected static Mezzago getMainProgram() {
        return mainProgram;
    }
}
